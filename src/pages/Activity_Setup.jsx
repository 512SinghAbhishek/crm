...
import AddPermissionForm from '../components/ActivitySetup/AddActivitysetupForm';
import EditPermissionForm from '../components/ActivitySetup/EditActivitysetupForm';
import EditActivitysetupForm from '../components/ActivitySetup/EditActivitysetupForm';

const Activity_Setup = () => {
  ...
  const columnDefs = [
    ...
    // { headerName: 'Is Billable', field: 'status', enablePivot: true, cellRenderer: (params) => params.value ? 'Active' : 'Inactive' },
    // { headerName: 'Is Billable', field: 'status', enablePivot: true, cellRenderer: (params) => params.value ? 'Active' : 'Inactive' }
