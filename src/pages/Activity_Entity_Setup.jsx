...
import AddActivity_Entity_SetupForm from '../components/Activity_Entity_Setup/AddActivity_Entity_SetupForm';
import EditActivity_Entity_SetupForm from '../components/Activity_Entity_Setup/EditActivity_Entity_SetupForm';

const Activity_Entity_Setup = () => {
      ...
      <div style={{
        ...
        >
          ...
          <FormControl sx={{ m: 1, minWidth: 150 }} size="small">
            <InputLabel id="select-second-views-label" style={{ fontSize: ".8rem" }}>Select Views</InputLabel>
            <Select
              labelId="select-second-views-label"
              id="select-second-views"
              label="Select Views"
              sx={{
                height: 30, // Set height for the Select
                "& .MuiSelect-select": {
                  padding: '0px', // Remove default padding
                  height: '30px', // Set the height of the select area
                },
                "& .MuiInputBase-input": {
                  height: '30px', // Set the height of the input field
                  display: 'flex',
...
export default Activity_Entity_Setup;
